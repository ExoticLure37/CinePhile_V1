        ...
        <div className="flex flex-col items-center px-6 py-10 bg-[#121212] min-h-screen text-white">
            <div className="w-full max-w-4xl space-y-8">
                ...
                <div className="bg-gradient-to-r from-gray-800 to-gray-900 p-6 rounded-xl shadow-xl">
                    <h2 className="text-2xl font-bold mb-4 text-center text-white">Send a Friend Request</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-xl shadow-md">
                        <h3 className="text-xl font-semibold mb-4 text-center">Pending Requests</h3>
                        <ul className="space-y-3">
                            {pRequest.length === 0 && (
                                <p className="text-gray-400 text-center">No pending requests</p>
                            )}
                            {pRequest.map((e) => (
                                <li key={e.userId} className="flex justify-between items-center px-4 py-3 bg-gray-700 rounded-lg hover:bg-gray-600 transition-all">
                                    <Link
                                        to={`/profile/${e.userId}`}
                    ...
                    {/* Sent Requests */}
                    <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-xl shadow-md">
                        <h3 className="text-xl font-semibold mb-4 text-center">Requests Sent</h3>
                        <ul className="space-y-3">
                            {rSent.length === 0 && (
