                ...
                open && (
                    <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn">
                        <div className="bg-[#1a1a1a]/90 rounded-2xl max-w-[140vh] w-[95vw] shadow-[0_8px_30px_rgb(0,0,0,0.25)] relative max-h-[90vh] overflow-y-auto scrollbar-hide border border-gray-700">
                            ...
                            {/* Plus Button with Tooltip */}
                            <div className="absolute right-[89vh] top-[51.5vh] z-50" onClick={(e) => e.stopPropagation()}>
                                <div className="relative">
                                    <button
                            ...
                            <div className="flex flex-col px-8 pt-4 pb-6 space-y-4 text-white">
                                <div className="flex justify-between items-center mb-2">
                                    <h2 className="text-4xl font-extrabold tracking-tight">{media.primaryTitle}</h2>
                                    <a
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-2 text-sm text-gray-300 pt-2">
                                    <p><span className="font-semibold text-white">Genres:</span> {media.genres?.join(', ') || 'N/A'}</p>
                                    <p><span className="font-semibold text-white">Languages:</span> {media.spokenLanguages?.join(', ') || 'N/A'}</p>
                                    <p><span className="font-semibold text-white">Country:</span> {media.countriesOfOrigin?.join(', ') || 'N/A'}</p>
                                    <p><span className="font-semibold text-white">Type:</span> {media.type || 'N/A'}</p>
                                    <p><span className="font-semibold text-white">Release Date:</span> {media.releaseDate || 'N/A'}</p>
                                </div>
                            </div>
                        </div>
                    </div>
