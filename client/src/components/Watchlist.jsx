        ...
        try {
            if (type === "Global Watchists") {
                ...
                if (type === "Favorites Watchlists") {
                    const filteredWatchlists = wt.filter((item) => checkIsPresent(item.watchlist_id));
                                    ...
                                    >
                                        <div className="flex gap-3 items-center">
                                            ...
                                            <button onClick={() => handleNavigate(type)}>
                                                <h2 className="text-lg font-semibold text-white tracking-tight hover:underline">{type.title}</h2>
                                            </button>
                                        </div>
