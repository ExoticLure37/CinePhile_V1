...
function TVShows() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('https://imdb236.p.rapidapi.com/imdb/most-popular-tv', {
                headers: {
            ...
            setPopularTVShows(response.data.slice(0, 30)); // Store only 20 results
        } catch (error) {
            console.error(error);
        }
    };
    ...
    const handleNext = () => {
        if (currentIndex + itemsPerPage < popularTVShows.length) {
            ...
            <div className="flex flex-col my-8 gap-10 ml-10">
                ...
                <div className="flex flex-col gap-5 relative">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            onClick={handleNext}
                            disabled={currentIndex + itemsPerPage >= popularTVShows.length}
                            className="text-white hover:scale-125 transition-all duration-300 p-2 disabled:opacity-30"
                        >
