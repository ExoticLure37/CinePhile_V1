...
function TopMoviesShowsPage() {
    ...
    const fetchData = async () => {
        try {
            ...
            setTopMoviesShows(response.data);
        } catch (error) {
            console.error(error);
        } finally {
        ...
        <div className="min-h-screen flex flex-col bg-[#141414]">
            ...
            {loading ? (
                ...
                <>
                    ...
                    {visibleCount < topMoviesShows.length && (
...
export default TopMoviesShowsPage;
